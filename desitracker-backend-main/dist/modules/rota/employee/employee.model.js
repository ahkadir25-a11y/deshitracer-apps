...
// ──────────────────────────────────────────────────────────────────────────────
const rotaEmployeeSchema = new mongoose_1.Schema({
...
rotaEmployeeSchema.index({ business: 1, email: 1 }, { unique: true, partialFilterExpression: { isDeleted: false } });
exports.RotaEmployee = (0, mongoose_1.model)('RotaEmployee', rotaEmployeeSchema);
