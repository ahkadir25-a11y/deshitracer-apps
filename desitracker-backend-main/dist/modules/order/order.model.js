...
const PaymentSchema = new mongoose_1.Schema({
    ...
    paidBy: { type: mongoose_1.Types.ObjectId, ref: "User" },
    paidByName: { type: String, default: "" },
    paidAt: { type: Date, default: Date.now },
    note: { type: String, default: "" },
}, { _id: true });
// Void request — waiter requests, kitchen / manager decides.
const VoidRequestSchema = new mongoose_1.Schema({
    itemId: { type: mongoose_1.Types.ObjectId, required: true },
    itemName: { type: String, default: "" },
    quantity: { type: Number, default: 1 },
    reason: { type: String, required: true },
    requestedBy: { type: mongoose_1.Types.ObjectId, ref: "User" },
...
const OrderSchema = new mongoose_1.Schema({
    ...
    user_id: { type: mongoose_1.Types.ObjectId, ref: "User", required: false, index: true },
    ...
    staffUserId: { type: mongoose_1.Types.ObjectId, ref: "User", required: false, index: true },
