...
const productSchema = new mongoose_1.Schema({
    ...
    discount_percent: { type: Number, min: 0, max: 100, default: 0 },
    product_options_ids: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'ProductOption' }],
...
function isDiscountActive(doc, now = new Date()) {
...
// Virtuals
productSchema.virtual('discount_active').get(function () {
    return isDiscountActive(this);
});
productSchema.virtual('current_discount_percent').get(function () {
    var _a;
    return isDiscountActive(this) ? ((_a = this.discount_percent) !== null && _a !== void 0 ? _a : 0) : 0;
});
